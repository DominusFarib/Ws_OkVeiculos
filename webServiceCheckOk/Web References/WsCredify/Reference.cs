...
namespace webServiceCheckOk.WsCredify {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="server.consultaBinding", Namespace="urn:server.consultas")]
    public partial class serverconsulta : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public serverconsulta() {
            this.Url = global::webServiceCheckOk.Properties.Settings.Default.webServiceCheckOk_WsCredify_server_consulta;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:server.consultas#consultar", RequestNamespace="urn:server.consultas", ResponseNamespace="urn:server.consultas")]
        [return: System.Xml.Serialization.SoapElementAttribute("xmlResposta")]
        public string Consultar(string xmlRequisicao) {
        ...
        /// <remarks/>
        public void ConsultarAsync(string xmlRequisicao) {
            this.ConsultarAsync(xmlRequisicao, null);
        }
        
        /// <remarks/>
        public void ConsultarAsync(string xmlRequisicao, object userState) {
            ...
            this.InvokeAsync("Consultar", new object[] {
                        xmlRequisicao}, this.ConsultarOperationCompleted, userState);
        }
